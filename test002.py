...
root = Tk()
root.title('C:\code\py\songs')  #giving the title for our window
root.geometry("500x400")
 
# making function
def play():
    playsound("calvin.mp3")
 
# title on the screen you can modify it   
title=Label(root,text="ray",bd=9,relief=GROOVE,
...
info=Label(root,text="Click on the button above to play song  baka",
